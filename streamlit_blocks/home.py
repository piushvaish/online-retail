...
def display_home():
    ...
    st.markdown("""
    We have generated this showcase of what we can help our clients with by using the data from <a href="https://www.olist.com/" target="_blank">Olist</a>, 
    the largest department store in Brazilian marketplaces. 
    Olist connects small businesses from all over Brazil to channels without 
